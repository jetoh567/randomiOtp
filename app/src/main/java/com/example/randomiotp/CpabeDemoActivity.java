...
public class CpabeDemoActivity extends AppCompatActivity {

    private static final String TAG = "CpabeDemoActivity";
...
//    static String decfile ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpabe_demo);

        gpsTracker = new GpsTracker(CpabeDemoActivity.this);
    ...
    public void encDec(){
        ...
        String time = "201911201233";
        String gps = "100";

        try {
            FileOutputStream fos_pub_key = openFileOutput("pub_key",Context.MODE_PRIVATE);
            FileOutputStream fos_master_key = openFileOutput("master_key",Context.MODE_PRIVATE);
            FileOutputStream fos_prv_key = openFileOutput("prv_key",Context.MODE_PRIVATE);
